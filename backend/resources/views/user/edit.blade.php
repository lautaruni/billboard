                    ...
                    <div class="page-content">
                        {!! Form::model($user,['route'=>['users.update',$user->id],'method'=>'PUT']) !!}
                            ...
                            <div class="col-sm-8">
                                <div class="col-sm-12">
                                    {!! Form::label('Nombre',null) !!}
                                    {!! Form::email('email',null,['class'=>'col-sm-12 input-lg','placeholder'=>'Ej: Actor, Actriz, Director, Diseñador, Escenógrafo, etc.']) !!}
                                </div>
                            </div>
                            <div class="col-sm-8">
                                <div class="col-sm-12">
                                    {!! Form::label('Nombre',null) !!}
                                    {!! Form::password('password',null,['class'=>'col-sm-12 input-lg','placeholder'=>'Ej: Actor, Actriz, Director, Diseñador, Escenógrafo, etc.']) !!}
                                </div>
                            </div>
                            <div class="col-sm-12">
