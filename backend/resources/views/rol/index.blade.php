@extends('main')
    @section('page-content')
                ...
                <div id="page-wrapper">
                    ...
                    @endif
                    <!--BEGIN CONTENT-->
                    {!! Form::open(['route'=>['rols.destroy',0],'method'=>'DELETE']) !!}
                        ...
                        <div id="page_bar">
                            ...
                            <div class="col-sm-8">
                                <div class="btn-group pull-right">
                                    ...
                                    <a href="{!! URL::to('rols/create') !!}" class="btn btn-success" ><i class="fa fa-plus-circle"></i> Agregar Rol</a>
                                </div>
                            </div>
                        </div>
                                        ...
                                        @foreach($rols as $rol)
                                            <tr>
                                                ...
                                                <td><div class="btn-group">
                                                    <a href="{!! URL::to('rols/'.$rol->rol_id.'/edit') !!}" class="btn btn-info" >Editar</a>
                                                </div></td>
                                            </tr>
                                        @endforeach
                                    </table>
