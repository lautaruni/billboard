    ...
    @section('page-content')
                ...
                <div id="page-wrapper">
                    ...
                    <div class="page-content">
                        {!! Form::model($event,['route'=>['events.update',$event->event_id],'method'=>'PUT','files'=>true]) !!}
                            <div id="event-form" class="col-sm-8">
                                ...
                                <div class="form-group col-sm-12">
                                    ...
                                    @foreach($categories as $category)
                                        <label>
                                        @if(in_array($category->category_id,$categories_inEvent))
                                            {!! Form::checkbox('category[]', $category->category_id, true) !!}
                                        @else
                                            {!! Form::checkbox('category[]', $category->category_id) !!}
                                        @endif
                                        {!! $category->name !!}</label>
                                    @endforeach
                                </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group col-sm-12">
                                    ...
                                    <img id="poster_preview" src="{!! URL::to('images/events/'.$event->poster) !!}" height="200" alt="">
                                </div>
                                <div class="form-group col-sm-12">
                                ...
                                <div class="form-group col-sm-12">
                                    ...
                                    <input type="number" name="priority" min='0' max='5' value="{!! $event->priority !!}" />
                                </div>
                                 <div class="form-group col-sm-12">
